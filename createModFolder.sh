...
cp /var/www/krakenmeister.com/civbuilder/public/thumbnail.jpg ./
...
mkdir dat
cd dat
cp /var/www/krakenmeister.com/civbuilder/public/empires2_x2_p1.dat ./
...
mkdir civ_emblems
cd civ_emblems
cp -r /var/www/krakenmeister.com/civbuilder/public/civ_emblems/. ./
cd ..
mkdir uniticons
mkdir civ_techtree
cd ..
...
mkdir widgetui
cd widgetui
cp /var/www/krakenmeister.com/civbuilder/public/civTechTrees.json ./
mkdir textures
cd textures
mkdir ingame
cd ingame
