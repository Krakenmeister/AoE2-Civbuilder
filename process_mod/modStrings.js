...
const civBonusStrings = [
	...
	"Infantry cost -15% in Dark, -20% in Feudal, -25% in Castle, -30% in Imperial Age",
	...
	"Transport Ships 2x hit points, +20 carry capacity",
	...
	"Soldiers receive 33% less bonus damage",
	...
	"Villagers carry +3",
	"Trebuchet units fire more accurately at units and small targets",
	...
	"Shock Infantry +6 attack vs. stone defenses",
	...
	"Spearmen deals +25% bonus damage",
	...
	"Mounted units regenerate 2/8/14 HP per minute, in the Feudal, Castle, Imperial Age",
	...
	"Dragon Ships replace Fast Fire Ships",
];
...
var uniqueCastleStrings = [
	...
	"Corvinian Army (Unique Unit gold cost converted to additional food/wood cost)",
	...
	"Coiled Serpent Array (Spearman-line and Unique Unit gain additional HP when near each other)",
	"Red Cliff Tactics (Demolition Ships and Fire Archers deal fire damage to ships and buildings)",
...
var uniqueImpStrings = [
	...
	"Elite Mercenaries (team members can train 5 free elite versions of your Unique Unit per castle)",
	...
	"Kataparuto (Trebuchet units fire, pack faster)",
	...
	"Shigetō Yumi (Unique Unit, Mounted Archers, and Towers attack 15% faster and deal +2 anti-unique unit damage)",
	"Bolt Magazine (Archer-line, Lou Chans, and War Chariots fire additional projectiles)",
...
const teamBonusStrings = [
	...
	"Docks cost -15%",
	"Scout Cavalry, Light Cavalry, Hussar +1 attack vs. Ranged Soldiers",
...
function interperateLanguage(json_path, txt_path) {
	...
	stringStream.write('8267 "Research Fabric Shields (' + getUniqueName(14, "imptech") + ', Slingers, Shock Infantry +1 armor/+2 pierce armor.)"\n');
	stringStream.write('28267 "Research <b>Fabric Shields<b> (<cost>) \\n' + getUniqueName(14, "imptech") + ', Slingers, Shock Infantry have +1 armor/+2 pierce armor."\n');
	...
	stringStream.write('8477 "Research Coiled Serpent Array (Spearman-line and ' + getUniqueName(55, "castletech") + ' gain additional HP when near each other)"\n');
	stringStream.write('28477 "Research <b>Coiled Serpent Array<b> (<cost>)\\nSpearman-line and ' + getUniqueName(55, "castletech") + ' gain additional HP when near each other."\n');
	...
	uniqueCastleStrings[55] = "Coiled Serpent Array (Spearman-line and " + getUniqueName(55, "castletech") + " gain additional HP when near each other)";
	...
	uniqueImpStrings[14] = "Fabric Shields (" + getUniqueName(14, "imptech") + ", Slingers, Shock Infantry +1/+2P armor)";
	// uniqueImpStrings[36] = "Berserkergang (" + getUniqueName(36, "imptech") + " can regenerate)";
	uniqueImpStrings[53] = "Shigeto Yumi (" + getUniqueName(53, "imptech") + ", Mounted Archers, and Towers attack 15% faster and deal +2 anti-unique unit damage)";

	for (var i = 0; i < civs.techtree.length; i++) {
		if (civs.description[i] != "") {
			stringStream.write(i + 120150 + ' "' + civs.description[i] + " civilization \\n\\n");
		} else {
	...
	stringStream.write('7503 "Brigandine Armor"\n');
	stringStream.write('8503 "Research Brigandine Armor (Camels and Cavalry Archers +2/+1P armor)"\n');
	stringStream.write('28503 "Research <b>Brigandine Armor<b> (<cost>)\\nCamels and Cavalry Archers +2/+1P armor."\n');
	stringStream.write('17503 "Brigandine\\nArmor"\n');
	...
	stringStream.write('8514 "Research Shigeto Yumi (' + getUniqueName(53, "imptech") + ', Mounted Archers, and Towers attack 15% faster and deal +2 bonus damage vs. unique units)"\n');
	stringStream.write('28514 "Research <b>Shigeto Yumi<b> (<cost>)\\n' + getUniqueName(53, "imptech") + ', Mounted Archers, and Towers attack 15% faster and deal +2 bonus damage vs. unique units."\n');
