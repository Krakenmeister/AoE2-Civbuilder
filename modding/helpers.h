...
const vector<int> techTreeIDs = {254, 258, 259, 262, 255, 257, 256, 260, 261, 263, 276, 277, 275, 446, 447, 449, 448, 504, 10,	1,	 3,	  5,  7,
								 31,  48,  42,	37,	 646, 648, 650, 652, 706, 708, 710, 712, 782, 784, 801, 803, 838, 840, 842, 890, 925, 927};
const vector<int> basicTechs = {-1,	 -1,  -1,  -1,	414, 222, 207, 217, 264, 87,  197, 429, 433, 384, 716, 215, 602, 147, 151, 100, 237, 99,  98,  192,
								218, 85,  437, 436, 25,	 204, 254, 428, 166, 209, 265, 235, 236, 630, 631, 714, 715, 435, 39,  149, 162, 96,  255, 358,
								257, 320, 94,  239, 603, 188, 211, 212, 219, 199, 200, 201, 67,	 82,  80,  74,	76,	 77,  604, 243, 246, 605, 242, 244,
								-1,	 -1,  35,  37,	376, 65,  374, 375, 373, 50,  51,  194, 93,	 140, 63,  380, 322, 54,  47,  64,	377, 608, 379, 321,
								315, 316, 319, 441, 439, 231, 252, 45,	233, 230, 438, 8,	280, 213, 249, 55,	182, 278, 279, 202, 203, 221, 48,  23,
								17,	 15,  14,  13,	12,	 434, 189, 68,	75,	 81,  339, 180, 391, 256, 157, 161, 426, 220, 410, 216, 411, 413, 127, 137,
								148, 281, 210, 357, 150, 144, 332, 22,	101, 102, 103, 875, 480, 481, 837, 838, 886, 46};
...
const vector<int> ecoBuildings = {68, 129, 130, 131, 562, 563, 564, 565, 584, 585, 586, 587, 1711, 1720, 1734, 1808};
...
const vector<int> monasteries = {30, 31, 32, 104, 1806};
...
void giveUnitsNewBonus(DatFile *df, vector<int> unitIDs, int bonusID);
...
int allocateTech(DatFile *df, int techID, int civID);
void multiplyAllEffects(DatFile *df, vector<vector<int>> multipliedEffects);
void multiplyEffects(DatFile *df, int techID, int multiplier);
vector<int> getRandomCosts(int min, int max, int p, int maxTypes);
void setTechCosts(DatFile *df, vector<int> costs, int techID);
void applyModifiers(DatFile *df, bool blindnessModifier, double buildingMultiplier, double speedMultiplier, double healthMultiplier);
