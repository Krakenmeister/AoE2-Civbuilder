...
module.exports = {
    getRandomInt, generateSeed, drawFlag, generateFlags
}
...
function drawFlag (seed, symbol, output_path1, output_path2, output_path3, output_path4, input_path) {
    ...
    if (symbol != -1) {
        ...
        fs.writeFileSync(output_path1, buffer)
	fs.writeFileSync(output_path2, buffer)
	fs.writeFileSync(output_path3, buffer)
	fs.writeFileSync(output_path4, buffer)
...
function generateFlags (output_path1, output_path2, input_path) {
	...
	if (civName == 'berber' || civName == 'inca') {
	    drawFlag(seed, symbol, output_path1 + '/' + civName + 's.png', output_path2 + '/menu_techtree_' + civName + '.png', output_path2 + '/menu_techtree_' + civName + '_hover.png', output_path2 + '/menu_techtree_' + civName + '_pressed.png', input_path)
	} else {
	    drawFlag(seed, symbol, output_path1 + '/' + civName + '.png', output_path2 + '/menu_techtree_' + civName + '.png', output_path2 + '/menu_techtree_' + civName + '_hover.png', output_path2 + '/menu_techtree_' + civName + '_pressed.png', input_path)
	}
