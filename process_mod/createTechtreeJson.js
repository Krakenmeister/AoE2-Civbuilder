...
function createTechtreeJson(data_json, techtree_json) {
  ...
  for (let i = 0; i < civ.techtree.length; i++) {
    ...
    for (let j = 0; j < civ.civ_bonus[i].length; j++) {
      switch (civ.civ_bonus[i][j]) {
        ...
        case 300:
          ...
          break;
        case 307:
          removeNode("Two-Handed Swordsman", techtree.civ_techs_units);
          removeNode("Champion", techtree.civ_techs_units);
          addSpecialNodes([specialNodes["legionary"]], techtree.civ_techs_units, civ.techtree[i][6], "Spearman");
          break;
        case 314:
          removeNode("Paladin", techtree.civ_techs_units);
          addSpecialNodes([specialNodes["savar"]], techtree.civ_techs_units, civ.techtree[i][33], "");
          break;
        case 316:
          for (let i = 0; i < techtree.civ_techs_units.length; i++) {
            if (techtree.civ_techs_units[i]["Building ID"] == 104) {
              techtree.civ_techs_units[i]["Building ID"] = 1806;
            }
          }
          removeNode("Monastery", techtree.civ_techs_buildings);
          addSpecialNodes([specialNodes["fortified_church"]], techtree.civ_techs_buildings, civ.techtree[i][146], "House");
          addSpecialNodes([specialNodes["warrior_priest"]], techtree.civ_techs_units, civ.techtree[i][146], "Devotion");
          break;
        case 317:
          addSpecialNodes([specialNodes["mule_cart"]], techtree.civ_techs_buildings, 1, "Mining Camp");
          for (let i = 0; i < techtree.civ_techs_buildings.length; i++) {
            if (techtree.civ_techs_buildings[i]["Name"] == "Mining Camp" || techtree.civ_techs_buildings[i]["Name"] == "Lumber Camp") {
              techtree.civ_techs_buildings[i]["Node Status"] = "NotAvailable";
            }
          }
          for (let i = 0; i < techtree.civ_techs_units.length; i++) {
            if (techtree.civ_techs_units[i]["Building ID"] == 584 || techtree.civ_techs_units[i]["Building ID"] == 562) {
              techtree.civ_techs_units[i]["Building ID"] = 1808;
            }
          }
          break;
      }
    ...
    let UTs = [];
    for (let i = 0; i < civ.castletech.length; i++) {
      UTs.push(UTArray[0][civ.castletech[i]]);
    }
    for (let i = 0; i < civ.imptech.length; i++) {
      UTs.push(UTArray[1][civ.imptech[i]]);
    }
...
const specialNodes = {
  ...
  savar: {
    ...
    "Building ID": 101,
    "Draw Node Type": "UnitTech",
    "Help String ID": 105703,
    "Link ID": 283,
    "Link Node Type": "UnitUpgrade",
    Name: "Savar",
    "Name String ID": 14703,
    "Node ID": 1813,
    "Node Status": "ResearchedCompleted",
    "Node Type": "UniqueUnit",
    "Picture Index": 410,
  ...
  fortified_church: {
    ...
    "Building upgraded from ID": -1,
    "Draw Node Type": "Building",
    "Help String ID": 105038,
    "Link ID": -1,
    "Link Node Type": "BuildingTech",
    Name: "Fortified Church",
    "Name String ID": 14038,
    "Node ID": 1806,
    "Node Status": "ResearchedCompleted",
    "Node Type": "BuildingTech",
    "Picture Index": 88,
  ...
  warrior_priest: {
    ...
    "Building ID": 1806,
    "Draw Node Type": "UnitTech",
    "Help String ID": 105037,
    "Link ID": -1,
    "Link Node Type": "BuildingTech",
    Name: "Warrior Priest",
    "Name String ID": 14037,
    "Node ID": 1811,
    "Node Status": "ResearchedCompleted",
    "Node Type": "UniqueUnit",
    "Picture Index": 409,
  ...
  mule_cart: {
    ...
    "Building upgraded from ID": -1,
    "Draw Node Type": "Building",
    "Help String ID": 105045,
    "Link ID": -1,
    "Link Node Type": "BuildingTech",
    Name: "Mule Cart",
    "Name String ID": 14045,
    "Node ID": 1808,
    "Node Status": "ResearchedCompleted",
    "Node Type": "BuildingTech",
    "Picture Index": 89,
...
const numVanillaUnits = 1900;
const numVanillaTechs = 980;
const UUArray = [
  ...
  ["Crusader Knight", 5610, 377, 5243, numVanillaTechs + 2, numVanillaUnits + 1, numVanillaUnits + 2],
  ...
  ["Centurion", 5450, 138, 5803, 882, 1790, 1792],
  ...
  [
    {
      ...
      "Building ID": 82,
      "Draw Node Type": "UnitTech",
      "Help String ID": 107326,
      "Link ID": -1,
      "Link Node Type": "BuildingTech",
      Name: "Atlatl",
      "Name String ID": 17326,
      "Node ID": 460,
      "Node Status": "ResearchedCompleted",
      "Node Type": "Research",
      "Picture Index": 33,
    ...
    },
    {
      ...
      "Building ID": 82,
      "Draw Node Type": "UnitTech",
      "Help String ID": 107256,
      "Link ID": -1,
      "Link Node Type": "BuildingTech",
      Name: "Kasbah",
      "Name String ID": 17256,
      "Node ID": 578,
      "Node Status": "ResearchedCompleted",
      "Node Type": "Research",
      "Picture Index": 33,
    ...
    },
    {
      ...
      "Building ID": 82,
      "Draw Node Type": "UnitTech",
      "Help String ID": 107419,
      "Link ID": -1,
      "Link Node Type": "BuildingTech",
      Name: "Yeomen",
      "Name String ID": 17419,
      "Node ID": 3,
      "Node Status": "ResearchedCompleted",
      "Node Type": "Research",
      "Picture Index": 33,
    ...
    },
    {
      ...
      "Building ID": 82,
      "Draw Node Type": "UnitTech",
      "Help String ID": 107307,
      "Link ID": -1,
      "Link Node Type": "BuildingTech",
      Name: "Stirrups",
      "Name String ID": 17307,
      "Node ID": 685,
      "Node Status": "ResearchedCompleted",
      "Node Type": "Research",
      "Picture Index": 33,
    ...
    },
    {
      ...
      "Building ID": 82,
      "Draw Node Type": "UnitTech",
      "Help String ID": 107342,
      "Link ID": -1,
      "Link Node Type": "BuildingTech",
      Name: "Burgundian Vineyards",
      "Name String ID": 17342,
      "Node ID": 754,
      "Node Status": "ResearchedCompleted",
      "Node Type": "Research",
      "Picture Index": 33,
    ...
    },
    {
      ...
      "Building ID": 82,
      "Draw Node Type": "UnitTech",
      "Help String ID": 107296,
      "Link ID": -1,
      "Link Node Type": "BuildingTech",
      Name: "Manipur Cavalry",
      "Name String ID": 17296,
      "Node ID": 627,
      "Node Status": "ResearchedCompleted",
      "Node Type": "Research",
      "Picture Index": 33,
    ...
    },
    {
      ...
      "Building ID": 82,
      "Draw Node Type": "UnitTech",
      "Help String ID": 107313,
      "Link ID": -1,
      "Link Node Type": "BuildingTech",
      Name: "Greek Fire",
      "Name String ID": 17313,
      "Node ID": 464,
      "Node Status": "ResearchedCompleted",
      "Node Type": "Research",
      "Picture Index": 33,
    ...
    },
    {
      ...
      "Building ID": 82,
      "Draw Node Type": "UnitTech",
      "Help String ID": 107369,
      "Link ID": -1,
      "Link Node Type": "BuildingTech",
      Name: "Stronghold",
      "Name String ID": 17369,
      "Node ID": 482,
      "Node Status": "ResearchedCompleted",
      "Node Type": "Research",
      "Picture Index": 33,
    ...
    },
    {
      ...
      "Building ID": 82,
      "Draw Node Type": "UnitTech",
      "Help String ID": 107368,
      "Link ID": -1,
      "Link Node Type": "BuildingTech",
      Name: "Great Wall",
      "Name String ID": 17368,
      "Node ID": 462,
      "Node Status": "ResearchedCompleted",
      "Node Type": "Research",
      "Picture Index": 33,
    ...
    },
    {
      ...
      "Building ID": 82,
      "Draw Node Type": "UnitTech",
      "Help String ID": 107311,
      "Link ID": -1,
      "Link Node Type": "BuildingTech",
      Name: "Steppe Husbandry",
      "Name String ID": 17311,
      "Node ID": 689,
      "Node Status": "ResearchedCompleted",
      "Node Type": "Research",
      "Picture Index": 33,
    ...
    },
    {
      ...
      "Building ID": 82,
      "Draw Node Type": "UnitTech",
      "Help String ID": 107252,
      "Link ID": -1,
      "Link Node Type": "BuildingTech",
      Name: "Royal Heirs",
      "Name String ID": 17252,
      "Node ID": 574,
      "Node Status": "ResearchedCompleted",
      "Node Type": "Research",
      "Picture Index": 33,
    ...
    },
    {
      ...
      "Building ID": 82,
      "Draw Node Type": "UnitTech",
      "Help String ID": 107324,
      "Link ID": -1,
      "Link Node Type": "BuildingTech",
      Name: "Bearded Axe",
      "Name String ID": 17324,
      "Node ID": 83,
      "Node Status": "ResearchedCompleted",
      "Node Type": "Research",
      "Picture Index": 33,
    ...
    },
    {
      ...
      "Building ID": 82,
      "Draw Node Type": "UnitTech",
      "Help String ID": 107427,
      "Link ID": -1,
      "Link Node Type": "BuildingTech",
      Name: "Anarchy",
      "Name String ID": 17427,
      "Node ID": 16,
      "Node Status": "ResearchedCompleted",
      "Node Type": "Research",
      "Picture Index": 33,
    ...
    },
    {
      ...
      "Building ID": 82,
      "Draw Node Type": "UnitTech",
      "Help String ID": 107370,
      "Link ID": -1,
      "Link Node Type": "BuildingTech",
      Name: "Marauders",
      "Name String ID": 17370,
      "Node ID": 483,
      "Node Status": "ResearchedCompleted",
      "Node Type": "Research",
      "Picture Index": 33,
    ...
    },
    {
      ...
      "Building ID": 82,
      "Draw Node Type": "UnitTech",
      "Help String ID": 107266,
      "Link ID": -1,
      "Link Node Type": "BuildingTech",
      Name: "Andean Sling",
      "Name String ID": 17266,
      "Node ID": 516,
      "Node Status": "ResearchedCompleted",
      "Node Type": "Research",
      "Picture Index": 33,
    ...
    },
    {
      ...
      "Building ID": 82,
      "Draw Node Type": "UnitTech",
      "Help String ID": 107270,
      "Link ID": -1,
      "Link Node Type": "BuildingTech",
      Name: "Grand Trunk Road",
      "Name String ID": 17270,
      "Node ID": 506,
      "Node Status": "ResearchedCompleted",
      "Node Type": "Research",
      "Picture Index": 33,
    ...
    },
    {
      ...
      "Building ID": 82,
      "Draw Node Type": "UnitTech",
      "Help String ID": 107272,
      "Link ID": -1,
      "Link Node Type": "BuildingTech",
      Name: "Pavise",
      "Name String ID": 17272,
      "Node ID": 494,
      "Node Status": "ResearchedCompleted",
      "Node Type": "Research",
      "Picture Index": 33,
    ...
    },
    {
      ...
      "Building ID": 82,
      "Draw Node Type": "UnitTech",
      "Help String ID": 107371,
      "Link ID": -1,
      "Link Node Type": "BuildingTech",
      Name: "Yasama",
      "Name String ID": 17371,
      "Node ID": 484,
      "Node Status": "ResearchedCompleted",
      "Node Type": "Research",
      "Picture Index": 33,
    ...
    },
    {
      ...
      "Building ID": 82,
      "Draw Node Type": "UnitTech",
      "Help String ID": 107291,
      "Link ID": -1,
      "Link Node Type": "BuildingTech",
      Name: "Tusk Swords",
      "Name String ID": 17291,
      "Node ID": 622,
      "Node Status": "ResearchedCompleted",
      "Node Type": "Research",
      "Picture Index": 33,
    ...
    },
    {
      ...
      "Building ID": 82,
      "Draw Node Type": "UnitTech",
      "Help String ID": 107380,
      "Link ID": -1,
      "Link Node Type": "BuildingTech",
      Name: "Eupseong",
      "Name String ID": 17380,
      "Node ID": 486,
      "Node Status": "ResearchedCompleted",
      "Node Type": "Research",
      "Picture Index": 33,
    ...
    },
    {
      ...
      "Building ID": 82,
      "Draw Node Type": "UnitTech",
      "Help String ID": 107399,
      "Link ID": -1,
      "Link Node Type": "BuildingTech",
      Name: "Hill Forts",
      "Name String ID": 17399,
      "Node ID": 691,
      "Node Status": "ResearchedCompleted",
      "Node Type": "Research",
      "Picture Index": 33,
    ...
    },
    {
      ...
      "Building ID": 82,
      "Draw Node Type": "UnitTech",
      "Help String ID": 107275,
      "Link ID": -1,
      "Link Node Type": "BuildingTech",
      Name: "Corvinian Army",
      "Name String ID": 17275,
      "Node ID": 514,
      "Node Status": "ResearchedCompleted",
      "Node Type": "Research",
      "Picture Index": 33,
    ...
    },
    {
      ...
      "Building ID": 82,
      "Draw Node Type": "UnitTech",
      "Help String ID": 107293,
      "Link ID": -1,
      "Link Node Type": "BuildingTech",
      Name: "Thalassocracy",
      "Name String ID": 17293,
      "Node ID": 624,
      "Node Status": "ResearchedCompleted",
      "Node Type": "Research",
      "Picture Index": 33,
    ...
    },
    {
      ...
      "Building ID": 82,
      "Draw Node Type": "UnitTech",
      "Help String ID": 107254,
      "Link ID": -1,
      "Link Node Type": "BuildingTech",
      Name: "Tigui",
      "Name String ID": 17254,
      "Node ID": 576,
      "Node Status": "ResearchedCompleted",
      "Node Type": "Research",
      "Picture Index": 33,
    ...
    },
    {
      ...
      "Building ID": 82,
      "Draw Node Type": "UnitTech",
      "Help String ID": 107379,
      "Link ID": -1,
      "Link Node Type": "BuildingTech",
      Name: "Hul'che Javelineers",
      "Name String ID": 17379,
      "Node ID": 485,
      "Node Status": "ResearchedCompleted",
      "Node Type": "Research",
      "Picture Index": 33,
    ...
    },
    {
      ...
      "Building ID": 82,
      "Draw Node Type": "UnitTech",
      "Help String ID": 107280,
      "Link ID": -1,
      "Link Node Type": "BuildingTech",
      Name: "Nomads",
      "Name String ID": 17280,
      "Node ID": 487,
      "Node Status": "ResearchedCompleted",
      "Node Type": "Research",
      "Picture Index": 33,
    ...
    },
    {
      ...
      "Building ID": 82,
      "Draw Node Type": "UnitTech",
      "Help String ID": 107281,
      "Link ID": -1,
      "Link Node Type": "BuildingTech",
      Name: "Kamandaran",
      "Name String ID": 17281,
      "Node ID": 488,
      "Node Status": "ResearchedCompleted",
      "Node Type": "Research",
      "Picture Index": 33,
    ...
    },
    {
      ...
      "Building ID": 82,
      "Draw Node Type": "UnitTech",
      "Help String ID": 107250,
      "Link ID": -1,
      "Link Node Type": "BuildingTech",
      Name: "

      "Node Status": "ResearchedCompleted",
      "Node Type": "Research",
      "Picture Index": 107,
    ...
    },
    {
      ...
      "Building ID": 82,
      "Draw Node Type": "UnitTech",
      "Help String ID": 107267,
      "Link ID": -1,
      "Link Node Type": "BuildingTech",
      Name: "Fabric Shields",
      "Name String ID": 17267,
      "Node ID": 517,
      "Node Status": "ResearchedCompleted",
      "Node Type": "Research",
      "Picture Index": 107,
    ...
    },
    {
      ...
      "Building ID": 82,
      "Draw Node Type": "UnitTech",
      "Help String ID": 107271,
      "Link ID": -1,
      "Link Node Type": "BuildingTech",
      Name: "Shatagni",
      "Name String ID": 17271,
      "Node ID": 507,
      "Node Status": "ResearchedCompleted",
      "Node Type": "Research",
      "Picture Index": 107,
    ...
    },
    {
      ...
      "Building ID": 82,
      "Draw Node Type": "UnitTech",
      "Help String ID": 107059,
      "Link ID": -1,
      "Link Node Type": "BuildingTech",
      Name: "Kataparuto",
      "Name String ID": 17059,
      "Node ID": 59,
      "Node Status": "ResearchedCompleted",
      "Node Type": "Research",
      "Picture Index": 107,
    ...
    },
    {
      ...
      "Building ID": 82,
      "Draw Node Type": "UnitTech",
      "Help String ID": 107292,
      "Link ID": -1,
      "Link Node Type": "BuildingTech",
      Name: "Double Crossbow",
      "Name String ID": 17292,
      "Node ID": 623,
      "Node Status": "ResearchedCompleted",
      "Node Type": "Research",
      "Picture Index": 107,
    ...
    },
    {
      ...
      "Building ID": 82,
      "Draw Node Type": "UnitTech",
      "Help String ID": 107438,
      "Link ID": -1,
      "Link Node Type": "BuildingTech",
      Name: "Shinkichon",
      "Name String ID": 17438,
      "Node ID": 445,
      "Node Status": "ResearchedCompleted",
      "Node Type": "Research",
      "Picture Index": 107,
    ...
    },
    {
      ...
      "Building ID": 82,
      "Draw Node Type": "UnitTech",
      "Help String ID": 107400,
      "Link ID": -1,
      "Link Node Type": "BuildingTech",
      Name: "Tower Shields",
      "Name String ID": 17400,
      "Node ID": 692,
      "Node Status": "ResearchedCompleted",
      "Node Type": "Research",
      "Picture Index": 107,
    ...
    },
    {
      ...
      "Building ID": 82,
      "Draw Node Type": "UnitTech",
      "Help String ID": 107274,
      "Link ID": -1,
      "Link Node Type": "BuildingTech",
      Name: "Recurve Bow",
      "Name String ID": 17274,
      "Node ID": 515,
      "Node Status": "ResearchedCompleted",
      "Node Type": "Research",
      "Picture Index": 107,
    ...
    },
    {
      ...
      "Building ID": 82,
      "Draw Node Type": "UnitTech",
      "Help String ID": 107294,
      "Link ID": -1,
      "Link Node Type": "BuildingTech",
      Name: "Forced Levy",
      "Name String ID": 17294,
      "Node ID": 625,
      "Node Status": "ResearchedCompleted",
      "Node Type": "Research",
      "Picture Index": 107,
    ...
    },
    {
      ...
      "Building ID": 82,
      "Draw Node Type": "UnitTech",
      "Help String ID": 107255,
      "Link ID": -1,
      "Link Node Type": "BuildingTech",
      Name: "Farimba",
      "Name String ID": 17255,
      "Node ID": 577,
      "Node Status": "ResearchedCompleted",
      "Node Type": "Research",
      "Picture Index": 107,
    ...
    },
    {
      ...
      "Building ID": 82,
      "Draw Node Type": "UnitTech",
      "Help String ID": 107420,
      "Link ID": -1,
      "Link Node Type": "BuildingTech",
      Name: "El Dorado",
      "Name String ID": 17420,
      "Node ID": 4,
      "Node Status": "ResearchedCompleted",
      "Node Type": "Research",
      "Picture Index": 107,
    ...
    },
    {
      ...
      "Building ID": 82,
      "Draw Node Type": "UnitTech",
      "Help String ID": 107422,
      "Link ID": -1,
      "Link Node Type": "BuildingTech",
      Name: "Drill",
      "Name String ID": 17422,
      "Node ID": 6,
      "Node Status": "ResearchedCompleted",
      "Node Type": "Research",
      "Picture Index": 107,
    ...
    },
    {
      ...
      "Building ID": 82,
      "Draw Node Type": "UnitTech",
      "Help String ID": 107423,
      "Link ID": -1,
      "Link Node Type": "BuildingTech",
      Name: "Citadels",
      "Name String ID": 17423,
      "Node ID": 7,
      "Node Status": "ResearchedCompleted",
      "Node Type": "Research",
      "Picture Index": 107,
    ...
    },
    {
      ...
      "Building ID": 82,
      "Draw Node Type": "UnitTech",
      "Help String ID": 107251,
      "Link ID": -1,
      "Link Node Type": "BuildingTech",
      Name: "Arquebus",
      "Name String ID": 17251,
      "Node ID": 573,
      "Node Status": "ResearchedCompleted",
      "Node Type": "Research",
      "Picture Index": 107,
    ...
    },
    {
      ...
      "Building ID": 82,
      "Draw Node Type": "UnitTech",
      "Help String ID": 107447,
      "Link ID": -1,
      "Link Node Type": "BuildingTech",
      Name: "Counterweights",
      "Name String ID": 17447,
      "Node ID": 454,
      "Node Status": "ResearchedCompleted",
      "Node Type": "Research",
      "Picture Index": 107,
    ...
    },
    {
      ...
      "Building ID": 82,
      "Draw Node Type": "UnitTech",
      "Help String ID": 107345,
      "Link ID": -1,
      "Link Node Type": "BuildingTech",
      Name: "Hauberk",
      "Name String ID": 17345,
      "Node ID": 757,
      "Node Status": "ResearchedCompleted",
      "Node Type": "Research",
      "Picture Index": 107,
    ...
    },
    {
      ...
      "Building ID": 82,
      "Draw Node Type": "UnitTech",
      "Help String ID": 107269,
      "Link ID": -1,
      "Link Node Type": "BuildingTech",
      Name: "Druzhina",
      "Name String ID": 17269,
      "Node ID": 513,
      "Node Status": "ResearchedCompleted",
      "Node Type": "Research",
      "Picture Index": 107,
    ...
    },
    {
      ...
      "Building ID": 82,
      "Draw Node Type": "UnitTech",
      "Help String ID": 107325,
      "Link ID": -1,
      "Link Node Type": "BuildingTech",
      Name: "Supremacy",
      "Name String ID": 17325,
      "Node ID": 440,
      "Node Status": "ResearchedCompleted",
      "Node Type": "Research",
      "Picture Index": 107,
    ...
    },
    {
      ...
      "Building ID": 82,
      "Draw Node Type": "UnitTech",
      "Help String ID": 107310,
      "Link ID": -1,
      "Link Node Type": "BuildingTech",
      Name: "Timurid Siegecraft",
      "Name String ID": 17310,
      "Node ID": 688,
      "Node Status": "ResearchedCompleted",
      "Node Type": "Research",
      "Picture Index": 107,
    ...
    },
    {
      ...
      "Building ID": 82,
      "Draw Node Type": "UnitTech",
      "Help String ID": 107426,
      "Link ID": -1,
      "Link Node Type": "BuildingTech",
      Name: "Crenellations",
      "Name String ID": 17426,
      "Node ID": 11,
      "Node Status": "ResearchedCompleted",
      "Node Type": "Research",
      "Picture Index": 107,
    ...
    },
    {
      ...
      "Building ID": 82,
      "Draw Node Type": "UnitTech",
      "Help String ID": 107425,
      "Link ID": -1,
      "Link Node Type": "BuildingTech",
      Name: "Artillery",
      "Name String ID": 17425,
      "Node ID": 10,
      "Node Status": "ResearchedCompleted",
      "Node Type": "Research",
      "Picture Index": 107,
    ...
    },
    {
      ...
      "Building ID": 82,
      "Draw Node Type": "UnitTech",
      "Help String ID": 107298,
      "Link ID": -1,
      "Link Node Type": "BuildingTech",
      Name: "Paper Money",
      "Name String ID": 17298,
      "Node ID": 629,
      "Node Status": "ResearchedCompleted",
      "Node Type": "Research",
      "Picture Index": 107,
    ...
    },
    {
      ...
      "Building ID": 82,
      "Draw Node Type": "UnitTech",
      "Help String ID": 107431,
      "Link ID": -1,
      "Link Node Type": "BuildingTech",
      Name: "Bogsveigar",
      "Name String ID": 17431,
      "Node ID": 49,
      "Node Status": "ResearchedCompleted",
      "Node Type": "Research",
      "Picture Index": 107,
    ...
    },
    {
      ...
      "Building ID": 82,
      "Draw Node Type": "UnitTech",
      "Help String ID": 107349,
      "Link ID": -1,
      "Link Node Type": "BuildingTech",
      Name: "Lechitic Legacy",
      "Name String ID": 17349,
      "Node ID": 783,
      "Node Status": "ResearchedCompleted",
      "Node Type": "Research",
      "Picture Index": 107,
    ...
    },
    {
      ...
      "Building ID": 82,
      "Draw Node Type": "UnitTech",
      "Help String ID": 107351,
      "Link ID": -1,
      "Link Node Type": "BuildingTech",
      Name: "Hussite Reforms",
      "Name String ID": 17351,
      "Node ID": 785,
      "Node Status": "ResearchedCompleted",
      "Node Type": "Research",
      "Picture Index": 107,
    ...
    },
    {
      ...
      "Building ID": 82,
      "Draw Node Type": "UnitTech",
      "Help String ID": 107504,
      "Link ID": -1,
      "Link Node Type": "BuildingTech",
      Name: "Field Repairmen",
      "Name String ID": 17504,
      "Node ID": numVanillaTechs + 85,
      "Node Status": "ResearchedCompleted",
      "Node Type": "Research",
      "Picture Index": 107,
      "Prerequisite IDs": [0, 0, 0, 0, 0],
    ...
    },
    {
      ...
      "Building ID": 82,
      "Draw Node Type": "UnitTech",
      "Help String ID": 107505,
      "Link ID": -1,
      "Link Node Type": "BuildingTech",
      Name: "Golden Age",
      "Name String ID": 17505,
      "Node ID": numVanillaTechs + 86,
      "Node Status": "ResearchedCompleted",
      "Node Type": "Research",
      "Picture Index": 107,
      "Prerequisite IDs": [0, 0, 0, 0, 0],
    ...
    },
    {
      ...
      "Building ID": 82,
      "Draw Node Type": "UnitTech",
      "Help String ID": 107506,
      "Link ID": -1,
      "Link Node Type": "BuildingTech",
      Name: "Villager's Revenge",
      "Name String ID": 17506,
      "Node ID": numVanillaTechs + 87,
      "Node Status": "ResearchedCompleted",
      "Node Type": "Research",
      "Picture Index": 107,
      "Prerequisite IDs": [0, 0, 0, 0, 0],
    ...
    },
    {
      ...
      "Building ID": 82,
      "Draw Node Type": "UnitTech",
      "Help String ID": 107509,
      "Link ID": -1,
      "Link Node Type": "BuildingTech",
      Name: "Gate Crashing",
      "Name String ID": 17509,
      "Node ID": numVanillaTechs + 88,
      "Node Status": "ResearchedCompleted",
      "Node Type": "Research",
      "Picture Index": 107,
      "Prerequisite IDs": [0, 0, 0, 0, 0],
    ...
    },
    {
      ...
      "Building ID": 82,
      "Draw Node Type": "UnitTech",
      "Help String ID": 107358,
      "Link ID": -1,
      "Link Node Type": "BuildingTech",
      Name: "Wootz Steel",
      "Name String ID": 17358,
      "Node ID": 832,
      "Node Status": "ResearchedCompleted",
      "Node Type": "Research",
      "Picture Index": 107,
    ...
    },
    {
      ...
      "Building ID": 82,
      "Draw Node Type": "UnitTech",
      "Help String ID": 107360,
      "Link ID": -1,
      "Link Node Type": "BuildingTech",
      Name: "Mahayana",
      "Name String ID": 17360,
      "Node ID": 834,
      "Node Status": "ResearchedCompleted",
      "Node Type": "Research",
      "Picture Index": 107,
    ...
    },
    {
      ...
      "Building ID": 82,
      "Draw Node Type": "UnitTech",
      "Help String ID": 107362,
      "Link ID": -1,
      "Link Node Type": "BuildingTech",
      Name: "Frontier Guards",
      "Name String ID": 17362,
      "Node ID": 836,
      "Node Status": "ResearchedCompleted",
      "Node Type": "Research",
      "Picture Index": 107,
    ...
    },
    {
      ...
      "Building ID": 82,
      "Draw Node Type": "UnitTech",
      "Help String ID": 107445,
      "Link ID": -1,
      "Link Node Type": "BuildingTech",
      Name: "Comitatenses",
      "Name String ID": 17445,
      "Node ID": 884,
      "Node Status": "ResearchedCompleted",
      "Node Type": "Research",
      "Picture Index": 107,
    ...
    },
    {
      ...
      "Building ID": 82,
      "Draw Node Type": "UnitTech",
      "Help String ID": 107406,
      "Link ID": -1,
      "Link Node Type": "BuildingTech",
      Name: "Fereters",
      "Name String ID": 17406,
      "Node ID": 921,
      "Node Status": "ResearchedCompleted",
      "Node Type": "Research",
      "Picture Index": 107,
    ...
    },
    {
      ...
      "Building ID": 82,
      "Draw Node Type": "UnitTech",
      "Help String ID": 107441,
      "Link ID": -1,
      "Link Node Type": "BuildingTech",
      Name: "Aznauri Cavalry",
      "Name String ID": 17441,
      "Node ID": 924,
      "Node Status": "ResearchedCompleted",
      "Node Type": "Research",
      "Picture Index": 107,
